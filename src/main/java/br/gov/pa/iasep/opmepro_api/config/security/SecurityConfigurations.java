    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        return httpSecurity
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/credenciado/todos-credenciados").permitAll()
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/usuario-permissoes/permissoes").permitAll()
                        .requestMatchers(HttpMethod.POST, "/api/usuario-permissoes/atribuir-permissao").permitAll()
                        .requestMatchers(HttpMethod.PUT, "/api/sessao/logout-usuario").permitAll()
